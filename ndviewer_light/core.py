...
# The Qt-free data layer lives in data.py so headless consumers can import it
# without PyQt5/ndv/vispy. Re-exported here: the public API is unchanged.
